/*
  ...
  - The values [CLIENTE] on the enum `Emisor` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "public"."Emisor_new" AS ENUM ('ADMIN', 'EMPLEADO', 'IA');
